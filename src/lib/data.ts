...
export const projectsData: ProjectInfo[] = [
  {
    ...
    descriptionFr:
      'Un thème de blog moderne et minimaliste construit avec Next.js et Tailwind CSS.',
  ...
  },
  {
    ...
    descriptionFr:
      'Une application de gestion de finances personnelles pour suivre ses dépenses et gérer son budget facilement.',
    tags: ['React', 'Next.js', 'MongoDB', 'Tailwind', 'Python'],
    imageUrl: '/image2.png',
    link: 'https://www.google.com',
  },
  {
    ...
    descriptionFr:
      'Une solution de stockage cloud pour gérer et partager ses fichiers en toute sécurité.',
    tags: ['React', 'Next.js', 'MongoDB', 'Tailwind', 'Python'],
    imageUrl: '/image3.png',
    link: 'https://www.google.com',
  },
