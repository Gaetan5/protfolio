  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 mt-4 dark:text-white/80">
        {t("contact_intro", locale)}
      </p>
      <form className="mt-10 w-full max-w-lg flex flex-col space-y-6 dark:text-black" onSubmit={handleSubmit} noValidate>
        ...
        {success && <div className="text-green-600 bg-green-50 border border-green-200 rounded p-2 mt-2 text-sm">{success}</div>}
      </form>
    </motion.section>
  );
}